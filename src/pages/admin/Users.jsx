    ...
    <div className='admin_wrapper'>
        <div className="top_wrapper">
            <div className="dash_top">            
                ...
                <h4 className='title'>WanaWema</h4> 
            </div> 
            <Search title='Tafuta MwanaWema'/>   
        </div>
        ...
        {users.map((m, index) => (
            <tr>
                ...
                <td data-label='Ajira' className='tab_column'>{m.emplo}</td>  
                ...
                <td data-label='Hali' className={m.status === 'Mjaheed'? 'green' : 'red'}>{m.status}</td>             
